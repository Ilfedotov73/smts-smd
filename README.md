...
## Лаб. 3
Требуется реализовать функцию reverse(). Функция reverse() принимает на вход строковую константу и разворачивает ее в обратном направлении. 
## Лаб. 4 
В финальной лабораторной работе необходимо написать любимую функцию сортировки и оформить её виде модульного кода (разделить код на .h и .c). Пример сортировки слиянием [https://github.com/Ilfedotov73/smts-smd/blob/main/labworks/msort.c]
